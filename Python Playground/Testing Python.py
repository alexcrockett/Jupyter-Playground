...
not_equal = not one == two  # insert any operator rendering the expression true. There are several options.
...
is_greater = not three < two  # insert any operator rendering the expression true. There are several options.
print(f"three is greater than two: {is_greater}")